    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { ref: ref, id: "sarufi-chat-container", style: {
            ...
            react_1.default.createElement("div", { style: {
                ...
                react_1.default.createElement("div", { className: "sarufi-message-body sarufi-message-body-w-arrow", style: {
                        maxWidth: 280,
                ...
                react_1.default.createElement("ul", null, chats === null || chats === void 0 ? void 0 :
                    chats.map(function (chat, index) { return (react_1.default.createElement(Chat, { chat: chat, key: index, onSubmit: onSubmit, mode: mode, fontFamily: fontFamily, fontSize: fontSize, index: index })); }),
                    loading && (react_1.default.createElement("div", { className: "sarufi-message-body sarufi-message-body-w-arrow", style: {
                            background: "var(--sarufi-received-box-bg)",
                            padding: "6px 8px 8px 9px",
                            marginTop: ".7rem",
                            position: "relative",
        ...
        react_1.default.createElement("form", { style: {
            ...
            react_1.default.createElement(button_1.default, { mode: mode, label: react_1.default.createElement("span", { className: "sarufi-flex-center" },
                    react_1.default.createElement(icons_1.SendIcon, { size: 30 })) })),
        react_1.default.createElement("p", { style: {
                fontSize: ".7rem",
                textAlign: "center",
                padding: "5px 0",
...
var Chat = function (_a) {
    ...
    return (react_1.default.createElement("li", { className: "".concat((chat === null || chat === void 0 ? void 0 : chat.sent) ? "sarufi-flex-end" : ""), style: {
        ...
        react_1.default.createElement("div", { className: "sarufi-message-body ".concat(hasMedia ? "" : "sarufi-message-body-w-arrow", " ").concat((chat === null || chat === void 0 ? void 0 : chat.sent) ? "sent" : ""), style: __assign({ background: (chat === null || chat === void 0 ? void 0 : chat.sent)
                ...
                : {})) },
            (!message || typeof message !== "string") && (chat === null || chat === void 0 ? void 0 : chat.actions) && menu && (react_1.default.createElement(react_1.default.Fragment, null,
